...
void Init_CPU() {
    ...
    CPU_getID(0, 0, &cpuFacName[0], &cpuFacName[1], &cpuFacName[2], &cpuFacName[3]);
    ...
    *(u32 *)&facName[8] = cpuFacName[2];
    ...
    for (i = 0x80000002; i <= 0x80000004; i++) {
        CPU_getID(i, 0, &cpuFacName[0], &cpuFacName[1], &cpuFacName[2], &cpuFacName[3]);
        for (j = 0; j < 4; j++)
    ...
    CPU_getID(1, 0, &cpuFacName[0], &cpuFacName[1], &cpuFacName[2], &cpuFacName[3]);
    printk(WHITE, BLACK, 
    ...
    CPU_getID(0x80000008, 0, &cpuFacName[0], &cpuFacName[1], &cpuFacName[2], &cpuFacName[3]);
    ...
    CPU_getID(0x80000000, 0, &cpuFacName[0], &cpuFacName[1], &cpuFacName[2], &cpuFacName[3]);

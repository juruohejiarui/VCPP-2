...
#define DMAS_virt2Phys(virtAddr) ((virtAddr) - (u64)DMAS_virtAddrStart + DMAS_physAddrStart)
#define DMAS_phys2Virt(physAddr) ((void *)((physAddr) - DMAS_physAddrStart + (u64)DMAS_virtAddrStart))

...
{
	unsigned long ConfigurationTableCount;
...
///////////////////
	...
	kernel_boot_para_info->ConfigurationTableCount = SystemTable->NumberOfTableEntries;
	kernel_boot_para_info->ConfigurationTable = SystemTable->ConfigurationTable;
